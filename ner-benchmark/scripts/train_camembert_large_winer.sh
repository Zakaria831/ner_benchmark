#!/bin/bash
#SBATCH --job-name=hf_camembert_large_winer
#SBATCH --output=logs/hf_camembert_large_winer_%j.log
...
# -----------------------
# CONFIG CAMEMBERT-LARGE
# -----------------------
MODEL_NAME="almanach/camembert-large"
RUN_TAG="camembert_large_priority"
...
# 2) Train (safe settings for large)
python "$PROJECT_ROOT/src/train_hf_winer_ner.py" \
  ...
  --wandb_run_name camembert_large_priority
